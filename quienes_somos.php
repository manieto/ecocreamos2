		...
		<div class="container content">
			<div class="row margin-bottom-40">
				<div class="col-md-6 col-md-offset-1 md-margin-bottom-40">
					...
					<p>Con la experiencia adquirida en estos <?php echo date('Y')-1997 ?> años, hemos decidido emprender una nueva etapa, centrándonos en el asesoramiento de los diferentes procesos constructivos de obra nueva y rehabilitación ecológica que impliquen y sigan nuestra filosofía.</p>
