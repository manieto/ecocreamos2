		...
		<div class="container content">
			<div class="row">
				<div class="col-xs-10 col-xs-offset-1 col-md-6 col-lg-6 padding-bottom-20">
					...
					<a href="assets/pdf/material_gutex/catalogo_gutex_2010.pdf" class="btn-u btn-u-large" target="_blank">Catálogo y aplicaciones</a>
				</div>
				<div class="col-xs-10 col-xs-offset-1 col-md-5 col-md-offset-0 col-lg-4">
					<a href="http://gutex-espana.eu/" target="_blank"><img src="assets/img/logos/gutex.png" class="img-responsive margin-bottom-10" alt="Gutex" /></a>
				</div>
			</div>
		</div>
