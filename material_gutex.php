		...
		<div class="container content">
			<div class="row">
				...
				<div class="col-md-5 col-lg-offset-1 col-lg-4">
					<a href="http://gutex.es/" target="_blank"><img src="assets/img/logos/gutex.png" class="img-responsive padding-bottom-20" alt="Gutex" /></a>
			...
			<div class="row">
				<div class="col-xs-12 padding-left-30 padding-right-30 padding-bottom-20">
					...
					<ul class="list-unstyled who">
						<li><i class="fa fa-file-pdf-o"></i> <a href="http://gutex.es/gama-de-productos/accesorios/fijacion-tirafondos/" target="_blank">Fijación / Tirafondos (12 elementos)</a></li>
						<li><i class="fa fa-file-pdf-o"></i> <a href="http://gutex.es/gama-de-productos/accesorios/perfileria-listones/" target="_blank">Perfilería / Listones (19 elementos)</a></li>
						<li><i class="fa fa-file-pdf-o"></i> <a href="http://gutex.es/gama-de-productos/accesorios/sellado-adhesivo/"    target="_blank">Sellado / Adhesivo (8 elementos)</a></li>
						<li><i class="fa fa-file-pdf-o"></i> <a href="http://gutex.es/gama-de-productos/accesorios/revoque-pintura/"     target="_blank">Revoque / Pintura (8 elementos)</a></li>
						<li><i class="fa fa-file-pdf-o"></i> <a href="http://gutex.es/gama-de-productos/accesorios/herramienta/"         target="_blank">Herramienta (2 elementos)</a></li>
						<li><i class="fa fa-file-pdf-o"></i> <a href="http://gutex.es/gama-de-productos/accesorios/varios/"              target="_blank">Varios (6 elementos)</a></li>
					</ul>
				</div>
			</div>
