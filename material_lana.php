...
<?php include "header.php";?>
		...
		<div class="breadcrumbs-v1">
			<div class="container">
				<h1>Lana de oveja: Aislamiento 100% natural</h1>
			</div>
		</div>
		<!--=== End Breadcrumbs v1 ===-->
		...
		<div class="container content">
			<div class="row">
				<div class="col-xs-10 col-xs-offset-1 col-md-5 col-lg-6 padding-bottom-20">
					...
					<p>Tal y como indica su nombre, es un aislamiento 100% natural compuesto por fieltros de lana de oveja. Los fieltros se unen entre sí mecánicamente, sin necesidad de uso de horno ni ligante químico.</p>
