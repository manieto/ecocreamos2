...
<?php include "header.php";?>
		...
		<div class="breadcrumbs-v1"
				 style="background: rgba(0, 0, 0, 0) url('assets/img/cabeceras/producto_pranan.jpg') no-repeat scroll center center / cover ;">
			<div class="container">
				<div class="row">
		...
		<div class="container content">
			<div class="row">
				<div class="col-xs-10 col-xs-offset-1 col-md-5 col-lg-6 padding-bottom-20">
					<p><span class="ecocreamos-logo-sm">EcoCreamos</span> es distribuidor exclusivo en las Islas Baleares de los productos <a target="_blank" href="http://www.pranan.com/">PRANAN</a>.</p>
			...
			<div class="row">
				<div class="col-xs-10 col-xs-offset-1 col-md-5 col-lg-6">
