...
<?php include "header.php";?>
		...
		<div class="container content">
			<div class="row">
				<div class="col-xs-10 col-xs-offset-1 col-md-7 col-lg-6 col-lg-offset-2 padding-bottom-20">
            ...
            <li><a target="pranan" href="http://www.pranan.com/phiwaves.html"    ><i class="fa fa-check"></i>PHIWAVES: Protector personal de las radiaciones electromagnéticas.</a></li>
            <li><a target="pranan" href="http://www.pranan.com/phione.html"      ><i class="fa fa-check"></i>PRANAN PHIONE: Neutraliza las radiaciones emitidas por el teléfono móvil.</a></li>
					</ul>
					<h2 class="title-v2 padding-top-20">Características</h2>
					...
					<p>Estos dispositivos no necesitan ningún tipo de fuente de alimentación, se activan automáticamente cuando los llevamos encima y entran en funcionamiento en cuando entran en contacto con los campos electromagnéticos, corrigiendo la anomalía de la Física fina.</p>
					<h2 class="title-v2 padding-top-20">Funcionamiento</h2>
					<ul class="list-unstyled who">
						<li><i class="fa fa-check"></i>Vida útil prácticamente ilimitada: La vida útil del dispositivo prácticamente coincide con la de los materiales con los que está fabricado, en principio ilimitado, salvo que se destruya la caja y la tecnología contenida.</li>
						<li><i class="fa fa-check"></i>Radio de acción entre 0,5 y 1 metro: El radio de acción de los dispositivos es aproximadamente de 1 metro, excepto en los utilizados para la protección de los móviles, que es de 0,5 metros.</li>
						<li><i class="fa fa-check"></i>Sin interferencias con otros dispositivos: En ningún caso, la tecnología empleada influye en la calidad de funcionamiento de los aparatos con los que estamos en contacto, como móviles, televisión, ordenadores, etc.</li>
					</ul>
				</div>
			</div>
		</div>
