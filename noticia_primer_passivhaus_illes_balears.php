			...
			<div class="row margin-bottom-20">
				<div class="col-md-6 col-lg-5 col-lg-offset-1 news-v3">
					<div class="news-v3-in-sm no-padding">
						...
						<h2>Primera Certificación de edificio <em>Passivhaus</em> de las Illes Balears</h2>
