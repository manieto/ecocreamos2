		...
		<div class="container content">
			<div class="row margin-bottom-20">
				...
				<div class="col-xs-12 col-md-6 col-lg-5 sm-margin-bottom-20">
					<img class="img-responsive" src="assets/img/proyecto_tierra.jpg" alt="Proyecto Tierra">
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-md-6 col-lg-5 col-lg-offset-1 sm-margin-bottom-20">
					<a href="assets/pdf/proyecto_tierra/articulo_tecnico.pdf" target="_blank" class="btn-u btn-u-large">Ver artículo técnico</a>
